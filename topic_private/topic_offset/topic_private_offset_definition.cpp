...
TopicPrivateOffsetDefinition::TopicPrivateOffsetDefinition() {
    schema_ = GetSchema();
}
...
std::shared_ptr<arrow::Schema> TopicPrivateOffsetDefinition::GetSchema() {
...
std::shared_ptr<arrow::RecordBatch> TopicPrivateOffsetDefinition::StructsToRecordBatch(const std::vector<TopicPrivateOffsetStructure>& structs) {
...
void TopicPrivateOffsetDefinition::UpdateStruct(int index, const TopicPrivateOffsetStructure& updated_struct, std::shared_ptr<arrow::RecordBatch>& record_batch) {
...
int TopicPrivateOffsetDefinition::SearchStructByOffset(boost::multiprecision::uint128_t offset, const std::shared_ptr<arrow::RecordBatch>& record_batch) {
    auto offset_high_array = std::static_pointer_cast<arrow::UInt64Array>(record_batch->column(0));
    auto offset_low_array = std::static_pointer_cast<arrow::UInt64Array>(record_batch->column(1));
